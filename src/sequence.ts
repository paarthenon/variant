...
import variant, {Creators, KeysOf, Property, VariantCreator, variantList, VariantModule, VariantModuleFromList, VariantOf} from './variant';
...
type ValidTypeInput<K extends string = 'type', T extends string = string> = ValidTypeCreatorInput<K, T> | Property<K, T>;
    ...
    = T extends ValidTypeInput<K>
        ? T extends string
            ...
            : T extends VariantCreator<infer TType, Func, K>
                ? TType
                : T extends Property<K, infer TType>
                    ? TType
                    : never
        : never;
;
...
> extends Remote<RT, K> {
    compare: (
        a: ValidTypeInput<K, KeysOf<RT, K>>, 
        b: ValidTypeInput<K, KeysOf<RT, K>>,
    ) => CompareResult;
    /**
